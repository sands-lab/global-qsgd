...
def parse_args():
    ...
    general.add_argument('--method', type=str, default='lgreco',
    ...
    dataset.add_argument('--data', type=str, default='/root/global-qsgd/wikitext-103',
    ...
    opt.add_argument('--adjust_freq', type=int, default=1000,
                     help='Number of iterations to adjust frequency')
    ...
    compression = parser.add_argument_group('gradient compression setup')
    compression.add_argument('--powersgd_rank',  type=int,
                      default=None,
                      help='rank of powerSGD gradient compression')
...
def main():
    ...
    if args.multi_gpu == 'ddp' and torch.distributed.is_initialized():
        ...
        if hook =="default":
            print("Default Hook")
            para_model.register_comm_hook(None, default_hook)
        elif hook =="standard_dithering":
            print("Standard Dithering Hook")
            para_model.register_comm_hook(None, standard_dithering_hook)
            ...
            state = lgreco_hook.PowerSGDState(torch.distributed.group.WORLD,
                                        ...
                                        adjust_gamma=0.25,
                                        adjust_beta=4)
            para_model.register_comm_hook(state, lgreco_hook.powerSGD_hook)
        elif hook =="powersgd":
            print("powersgd Hook")
